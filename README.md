...
<p align="center">
  This is the repository for my professional protfolio as Full Stack Developer.<br>
...
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=JoaccoG_portfolio&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=JoaccoG_portfolio)
[![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=JoaccoG_portfolio&metric=reliability_rating)](https://sonarcloud.io/summary/new_code?id=JoaccoG_portfolio)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=JoaccoG_portfolio&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=JoaccoG_portfolio)<br>
[![Technical Debt](https://sonarcloud.io/api/project_badges/measure?project=JoaccoG_portfolio&metric=sqale_index)](https://sonarcloud.io/summary/new_code?id=JoaccoG_portfolio)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=JoaccoG_portfolio&metric=bugs)](https://sonarcloud.io/summary/new_code?id=JoaccoG_portfolio)
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=JoaccoG_portfolio&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=JoaccoG_portfolio)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=JoaccoG_portfolio&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=JoaccoG_portfolio)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=JoaccoG_portfolio&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=JoaccoG_portfolio)

# Demo

You can see a demonstration of the app [clicking here](https://joaquingodoy.netlify.app/).<br>
Uou can see the actual app production and portfolio [clicking here](https://joaquingodoy.com/).<br>
